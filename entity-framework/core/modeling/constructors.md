...
* Par convention, les propriétés sans accesseurs Get ne sont pas mappées. (Cela a tendance à mapper les propriétés qui ne doivent pas être mappées, telles que les propriétés calculées.)
