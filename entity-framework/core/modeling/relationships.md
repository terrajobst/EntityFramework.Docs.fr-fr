...
* Si l’entité dépendante contient une propriété avec un nom, l’un de ces modèles est alors configuré comme clé étrangère :
...
Le code suivant montre comment configurer une clé principale composite.
