...
### [Nouveautés dans EF Core 2.0](core/what-is-new/index.md)
...
#### [MySQL (officiel)](core/providers/mysql/index.md)
...
#### [Oracle (pas encore disponible)](core/providers/oracle/index.md)
#### [MyCat](core/providers/my-cat/index.md)
#### [Communauté Firebird](core/providers/firebird-community/index.md)
...
#### [Geco (générateur de modèle inverse)](core/extensions/geco.md)
...
### [⤤ Informations de référence sur les API](https://docs.microsoft.com/dotnet/api/?view=efcore-2.0)
