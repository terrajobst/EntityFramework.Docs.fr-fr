...
## <a name="1-create-an-existing-database"></a><span data-ttu-id="f3c79-112">1. Créer une base de données existante</span><span class="sxs-lookup"><span data-stu-id="f3c79-112">1. Create an Existing Database</span></span>
