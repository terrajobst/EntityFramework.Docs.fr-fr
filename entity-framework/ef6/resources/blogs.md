...
Outre la documentation du produit, ces blogs peut être une source d’informations utiles sur Entity Framework :

## <a name="ef-team-blogs"></a>Blogs de l’équipe EF

- [Blog de .NET - Tag : Entity Framework](https://blogs.msdn.microsoft.com/dotnet/tag/entity-framework/)
- [Blog de l’ADO.NET (n’est plus en cours d’utilisation)](https://blogs.msdn.microsoft.com/adonet/)
- [Blog de conception Entity Framework (n’est plus en cours d’utilisation)](https://blogs.msdn.microsoft.com/efdesign/)

## <a name="current-and-former-ef-team-bloggers"></a>Blogueurs de l’équipe EF actuels et anciens
