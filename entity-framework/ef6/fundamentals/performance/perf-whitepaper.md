...
Dernière mise à jour : 2014 mai

------------------------------------------------------------------------

## <a name="1-introduction"></a>1. Présentation
...
## <a name="2-cold-vs-warm-query-execution"></a>2. À froid et Exécution de la requête à chaud
...
| `  var c1 = q1.First();`                                                                             | Exécution de requêtes LINQ      | -Chargement des métadonnées : Haute, mais mise en cache <br/> -Génération de vues : Potentiellement très élevé mais mis en cache <br/> -Évaluation des paramètres : Moyenne <br/> -Traduction des requêtes : Moyenne <br/> -Génération de matérialise : Moyenne mais mise en cache <br/> -Exécution de la requête de base de données : Potentiellement élevé <br/> + Connection. Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> Matérialisation d’objets : Moyenne <br/> -Recherche d’identité : Moyenne | -Chargement des métadonnées : Haute, mais mise en cache <br/> -Génération de vues : Potentiellement très élevé mais mis en cache <br/> -Évaluation des paramètres : Faible <br/> -Traduction des requêtes : Moyenne mais mise en cache <br/> -Génération de matérialise : Moyenne mais mise en cache <br/> -Exécution de la requête de base de données : Potentiellement élevé (meilleures requêtes dans certains cas) <br/> + Connection. Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> Matérialisation d’objets : Moyenne <br/> -Recherche d’identité : Moyenne | -Chargement des métadonnées : Haute, mais mise en cache <br/> -Génération de vues : Moyenne mais mise en cache <br/> -Évaluation des paramètres : Faible <br/> -Traduction des requêtes : Moyenne mais mise en cache <br/> -Génération de matérialise : Moyenne mais mise en cache <br/> -Exécution de la requête de base de données : Potentiellement élevé (meilleures requêtes dans certains cas) <br/> + Connection. Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> Matérialisation d’objets : Moyenne (plus rapide que EF5) <br/> -Recherche d’identité : Moyenne |
...
| `using(var db = new MyContext())` <br/> `{`                                                          | Création de contexte          | Moyenne                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Moyenne                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var q1 = ` <br/> `    from c in db.Customers` <br/> `    where c.Id == id1` <br/> `    select c;` | Création d’une expression de requête | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `  var c1 = q1.First();`                                                                             | Exécution de requêtes LINQ      | -Recherche ~~du chargement~~ des métadonnées : ~~Haute, mais mise en cache~~ Entrée <br/> -Afficher la recherche de ~~génération~~ : ~~Potentiellement très élevé mais mis en cache~~ Entrée <br/> -Évaluation des paramètres : Moyenne <br/> -Recherche de ~~traduction~~ de requête : Moyenne <br/> -Recherche de la ~~génération~~ de matérialise : ~~Moyenne mais mise en cache~~ Entrée <br/> -Exécution de la requête de base de données : Potentiellement élevé <br/> + Connection. Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> Matérialisation d’objets : Moyenne <br/> -Recherche d’identité : Moyenne | -Recherche ~~du chargement~~ des métadonnées : ~~Haute, mais mise en cache~~ Entrée <br/> -Afficher la recherche de ~~génération~~ : ~~Potentiellement très élevé mais mis en cache~~ Entrée <br/> -Évaluation des paramètres : Faible <br/> -Recherche de ~~traduction~~ de requête : ~~Moyenne mais mise en cache~~ Entrée <br/> -Recherche de la ~~génération~~ de matérialise : ~~Moyenne mais mise en cache~~ Entrée <br/> -Exécution de la requête de base de données : Potentiellement élevé (meilleures requêtes dans certains cas) <br/> + Connection. Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> Matérialisation d’objets : Moyenne <br/> -Recherche d’identité : Moyenne | -Recherche ~~du chargement~~ des métadonnées : ~~Haute, mais mise en cache~~ Entrée <br/> -Afficher la recherche de ~~génération~~ : ~~Moyenne mais mise en cache~~ Entrée <br/> -Évaluation des paramètres : Faible <br/> -Recherche de ~~traduction~~ de requête : ~~Moyenne mais mise en cache~~ Entrée <br/> -Recherche de la ~~génération~~ de matérialise : ~~Moyenne mais mise en cache~~ Entrée <br/> -Exécution de la requête de base de données : Potentiellement élevé (meilleures requêtes dans certains cas) <br/> + Connection. Open <br/> + Command.ExecuteReader <br/> + DataReader.Read <br/> Matérialisation d’objets : Moyenne (plus rapide que EF5) <br/> -Recherche d’identité : Moyenne |
| `}`                                                                                                  | Connection. Close          | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Faible                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Quand vous utilisez      | Procédez comme suit                                                                                                                                                                                                                                                                                                                              |
|:----------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| EDMGen          | Lorsque vous utilisez EDMGen pour générer vos fichiers à partir de la base de données, vos clés étrangères sont respectées et ajoutées au modèle en tant que tel. Pour plus d’informations sur les différentes options exposées par EDMGen visitez [http://msdn.microsoft.com/library/bb387165.aspx](https://msdn.microsoft.com/library/bb387165.aspx).                           |
...
*Remarque :*  When le déplacement de votre modèle vers des assemblys distincts n’oubliez pas de copier les chaînes de connexion du modèle dans le fichier de configuration de l’application du projet client.
...
-   Le cache du plan de requête est partagé pour tous les types de requêtes : Objets Entity SQL, LINQ to Entities et CompiledQuery.
...
-   Utilisation de IEnumerable @ no__t-0T @ no__t-1. Contient @ no__t-2 @ no__t-3 (valeur T).
...
### <a name="41-using-ienumerablelttgtcontainslttgtt-value"></a>4,1 utilisation de IEnumerable @ no__t-0T @ no__t-1. Contient @ no__t-2T @ no__t-3 (valeur T)

Entity Framework ne met pas en cache les requêtes qui appellent IEnumerable @ no__t-0T @ no__t-1. Contient @ no__t-2T @ no__t-3 (valeur T) par rapport à une collection en mémoire, étant donné que les valeurs de la collection sont considérées comme volatiles. L’exemple de requête suivant ne sera pas mis en cache et sera donc toujours traité par le compilateur de plan :
...
Entity Framework 6 contient des optimisations de la façon dont IEnumerable @ no__t-0T @ no__t-1. Contient @ no__t-2T @ no__t-3 (valeur T) qui fonctionne lorsque les requêtes sont exécutées. Le code SQL généré est beaucoup plus rapide à produire et plus lisible, et dans la plupart des cas, il s’exécute également plus rapidement sur le serveur.
...
Dans ce cas de bout en bout, Entity Framework 6 est Entity Framework 5 en raison des améliorations de performances apportées sur plusieurs parties de la pile, y compris une initialisation beaucoup plus légère et des recherches plus rapides MetadataCollection @ no__t-0T @ no__t-1.
...
Lorsque vous utilisez Code First pour configurer le mappage d’un modèle avec héritage, EF utilise TPH par défaut. par conséquent, toutes les entités de la hiérarchie d’héritage sont mappées à la même table. Consultez la section « Mappage avec l’API Fluent » de l’article « Code première dans entité Framework4.1 » dans MSDN Magazine ( [http://msdn.microsoft.com/magazine/hh126815.aspx](https://msdn.microsoft.com/magazine/hh126815.aspx)) pour plus d’informations.
...
| Visual Studio 2010 SP1, Entity Framework 4 | Génération SSDL : 1 seconde <br/> Génération de mappage : 1 seconde <br/> Génération CSDL : 1 seconde <br/> Génération ObjectLayer : 1 seconde <br/> Génération de vues : 1 h 53 min.   |
...
Entity Framework pouvez également créer des classes proxy dérivées de vos types POCO, qui sont utilisées lorsque vous souhaitez activer des fonctionnalités telles que le chargement différé et le suivi automatique des modifications sur les entités POCO. Vos classes POCO doivent remplir certaines conditions pour permettre d’Entity Framework utiliser des proxys, comme indiqué ici : [http://msdn.microsoft.com/library/dd468057.aspx](https://msdn.microsoft.com/library/dd468057.aspx).
...
Entity Framework par défaut génère du code SQL avec une sémantique de comparaison C @ no__t-0 null. Prenons l’exemple de requête suivant :
...
Dans cet exemple, nous comparons un certain nombre de variables Nullable à des propriétés Nullable sur l’entité, telles que RéfFournisseur et UnitPrice. Le SQL généré pour cette requête demande si la valeur du paramètre est la même que la valeur de la colonne, ou si les valeurs du paramètre et de la colonne sont null. Cela masque la manière dont le serveur de base de données gère les valeurs NULL et fournit une expérience de type C @ no__t-0 cohérente sur les différents fournisseurs de bases de données. En revanche, le code généré est un peu compliqué et peut ne pas s’exécuter correctement lorsque le nombre de comparaisons dans l’instruction WHERE de la requête augmente jusqu’à un grand nombre.

Une façon de traiter cette situation consiste à utiliser la sémantique null de la base de données. Notez que cela peut potentiellement se comporter différemment de la sémantique C @ no__t-0 null car, à ce stade, Entity Framework générera un SQL plus simple qui expose la manière dont le moteur de base de données gère les valeurs NULL. La sémantique null de la base de données peut être activée par contexte avec une seule ligne de configuration par rapport à la configuration du contexte :
...
Si votre application est une application MVC utilisant Code First, vous pouvez utiliser mini de StackExchange. Scott Hanselman décrit cet outil dans son blog à l’adresse : \<http://www.hanselman.com/blog/NuGetPackageOfTheWeek9ASPNETMiniProfilerFromStackExchangeRocksYourWorld.aspx>.
...
Dans cet exemple, l’activité de base de données est enregistrée dans la console, mais la propriété log peut être configurée pour appeler n’importe quel délégué Action @ no__t-0string @ no__t-1.
...
Où MDF @ no__t-0SessionLogin @ no__t-1Time @ no__t-2Max () est défini dans le modèle de la façon suivante :
